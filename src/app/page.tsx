        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <p className="text-gray-700">Regular Mass services and special liturgical celebrations</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-700">Whether you are seeking a spiritual home, looking to deepen your faith, or simply curious about Catholic life, we extend a warm invitation to join us.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-700">Weekly Sunday school both in Sinhala and English medium with regular Religious education programs conducted for all ages.</p>
            </motion.div>
            </div>
          </div>
        </div>
